...
class ID3 {
    ...
    //Implementacion del algoritmo ID3 con atributos de entrada
    //Lista de ejemplos y lista de atributos
    ...
    //Algoritmo que calcula si los atributos son viables o no
    ...
    //Calculamos la entropia a partir de p y n
     entropia(p, n){
        return -p*this.fixedLog(p) - n*this.fixedLog(n);
    }
    //Algoritmo en base 2 con ajuste ya que al hacer el logaritmo de 
    //0 el resultado era 0 y no se podia multiplicar por 0.
     fixedLog (number){
